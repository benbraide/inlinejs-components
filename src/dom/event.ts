...
export class EventElement extends CustomElement{
    protected unsubscribe_: ((e: string, m: string | null) => void) | null = null;
    ...
    protected HandleElementScopeDestroyed_(scope: IElementScope): void {
        ...
        const getMappedEvent = (e: string) => ((this.mobile && e in mobileMap) ? (mobileMap[e] as string) : null);
        
        (Array.isArray(this.type) ? this.type : [this.type]).forEach((t) => this.unsubscribe_?.(t, getMappedEvent(t)));
    }
    ...
    protected HandlePostAttributesProcessPostfix_(): void {
        ...
        if (target && type){
            ...
            const getMappedEvent = (e: string) => ((mobile && e in mobileMap) ? (mobileMap[e] as string) : null);
