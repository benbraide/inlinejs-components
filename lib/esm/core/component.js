...
import { EvaluateMagicProperty, FindComponentById, InsertHtml } from "@benbraide/inlinejs";
    ...
    HandleElementScopeCreated_(_a, postAttributesCallback) {
        ...
        super.HandleElementScopeCreated_(Object.assign({ scope }, rest), () => {
            ...
            if (src) { //Load component
                const magicGet = EvaluateMagicProperty(this.componentId_, this, '$get', '$'), insertText = (text) => InsertHtml({
