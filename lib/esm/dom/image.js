...
export class ImageElement extends CustomElement {
    ...
    UpdateFit_() {
        ...
        if (this.fit_) {
            ...
            const containerSize = {
                width: ((this.useParent && ((_a = this.parentElement) === null || _a === void 0 ? void 0 : _a.clientWidth)) || this.clientWidth),
                height: ((this.useParent && ((_b = this.parentElement) === null || _b === void 0 ? void 0 : _b.clientHeight)) || this.clientHeight),
            };
    ...
    EnableLazy_() {
        ...
        this.intersectionObserver_ = new IntersectionObserver((((_a = FindComponentById(this.componentId_)) === null || _a === void 0 ? void 0 : _a.GenerateUniqueId('img_')) || ''), options);
...
__decorate([
    Property({ type: 'boolean' })
], ImageElement.prototype, "useParent", void 0);
__decorate([
