...
import { FindComponentById, IntersectionObserver, IsObject, ResizeObserver } from "@benbraide/inlinejs";
...
export class ImageElement extends CustomElement {
    ...
    EnableLazy_() {
        ...
        const options = (IsObject(this.lazyOptions) ? this.lazyOptions : { root: this.lazyOptions });
        ...
        this.intersectionObserver_ = new IntersectionObserver((((_c = FindComponentById(this.componentId_)) === null || _c === void 0 ? void 0 : _c.GenerateUniqueId('img_')) || ''), options);
