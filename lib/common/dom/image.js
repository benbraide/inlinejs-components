...
exports.ImageElementCompact = exports.ImageElement = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
class ImageElement extends inlinejs_element_1.CustomElement {
    constructor() {
        super();
        this.loaded_ = false;
        this.src_ = null;
    ...
    UpdateFit_() {
        ...
        if (this.fit_) {
            ...
            const containerSize = {
                width: ((this.parent && ((_a = this.parentElement) === null || _a === void 0 ? void 0 : _a.clientWidth)) || this.clientWidth),
                height: ((this.parent && ((_b = this.parentElement) === null || _b === void 0 ? void 0 : _b.clientHeight)) || this.clientHeight),
            };
            const getRatio = (width, height) => ((this.fitType_ === 'cover') ? Math.max(width, height) : Math.min(width, height));
    ...
    EnableLazy_() {
        ...
        options.threshold = ((_b = (_a = options.threshold) !== null && _a !== void 0 ? _a : this.lazyThreshold) !== null && _b !== void 0 ? _b : 0);
        this.intersectionObserver_ = new inlinejs_1.IntersectionObserver((((_c = (0, inlinejs_1.FindComponentById)(this.componentId_)) === null || _c === void 0 ? void 0 : _c.GenerateUniqueId('img_')) || ''), options);
...
], ImageElement.prototype, "lazyOptions", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'number' })
], ImageElement.prototype, "lazyThreshold", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], ImageElement.prototype, "lazy", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], ImageElement.prototype, "parent", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], ImageElement.prototype, "UpdateSrcProperty", null);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], ImageElement.prototype, "UpdateFitProperty", null);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], ImageElement.prototype, "UpdateFitTypeProperty", null);
exports.ImageElement = ImageElement;
function ImageElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(ImageElement, 'image');
}
exports.ImageElementCompact = ImageElementCompact;
