...
exports.OverlayCompact = exports.Overlay = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
class Overlay extends inlinejs_element_1.CustomElement {
    constructor() {
        super();
        this.showCount_ = 0;
...
], Overlay.prototype, "visibleClass", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], Overlay.prototype, "overflowClass", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'object', checkStoredObject: true })
], Overlay.prototype, "visibleTarget", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'number' })
], Overlay.prototype, "UpdateZIndexProperty", null);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], Overlay.prototype, "UpdateWidthProperty", null);
exports.Overlay = Overlay;
function OverlayCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(Overlay);
}
exports.OverlayCompact = OverlayCompact;
