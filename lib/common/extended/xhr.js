...
exports.XhrCompact = exports.Xhr = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
class Xhr extends inlinejs_element_1.CustomElement {
    constructor() {
        super();
        this.loaded_ = false;
        this.src_ = '';
...
], Xhr.prototype, "target", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], Xhr.prototype, "mode", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], Xhr.prototype, "always", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], Xhr.prototype, "UpdateSrcProperty", null);
exports.Xhr = Xhr;
function XhrCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(Xhr);
}
exports.XhrCompact = XhrCompact;
