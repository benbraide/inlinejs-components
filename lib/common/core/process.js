...
exports.ProcessElementCompact = exports.ProcessElement = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
class ProcessElement extends inlinejs_element_1.CustomElement {
    constructor() {
        super({
            isTemplate: false,
            isHidden: false,
...
function ProcessElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(ProcessElement, 'process');
}
exports.ProcessElementCompact = ProcessElementCompact;
