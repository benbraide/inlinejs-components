...
exports.SketchHistoryCompact = exports.SketchHistory = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const sketch_plugin_1 = require("./sketch-plugin");
class SketchHistory extends sketch_plugin_1.SketchPlugin {
    constructor() {
        super('history');
        this.index_ = 0;
...
], SketchHistory.prototype, "size", void 0);
exports.SketchHistory = SketchHistory;
function SketchHistoryCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(SketchHistory);
}
exports.SketchHistoryCompact = SketchHistoryCompact;
